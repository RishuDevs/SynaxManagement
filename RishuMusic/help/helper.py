...
❖ ϻᴧᴅє ʙʏ  ➠ [sʏɴᴀx-ϻυsɪᴄ](https://t.me/SynaxBots) **
'''
...
❍ ᴄσηᴛᴧᴄᴛ - [ sʏɴᴀx](https://t.me/SynaxBots)
───────────────────────**
'''
    HELP_ALLBOT = '''
**───────────────────────
│ ᴡєʟᴄσϻє ᴛσ ˹[ʀɪsʜυ](https://t.me/SynaxBots)˼ ʙσᴛ sᴛᴧᴛυs │
───────────────────────
    ❖ │ ʀєᴧʟ ᴛɪϻє ʙσᴛ's sᴛᴧᴛυs │❖
───────────────────────

╭⎋ [sʏɴᴀx ϻυsɪᴄ](https://t.me/synaxBots) : ᴧʟɪᴠє 
╰⊚ υᴘᴛɪϻє : 12ʜ:38ϻ:50s | ᴄᴘυ : 5.0% | 
       υsᴧɢє : 24 | ᴧssɪsᴛᴧηᴛs : 01

───────────────────────
⊚ ʙσᴛ sᴛᴧᴛυs ᴧηᴅ ϻσʀє ʙσᴛs - [ᴄʟɪᴄᴋ ϻє](https://t.me/SynaxBots)
───────────────────────
⊚ ʟᴧsᴛ ᴄʜєᴄᴋєᴅ ση : ᴅᴧᴛє : 20 Sep 2024 
───────────────────────
❍ ᴘσᴡєʀєᴅ ʙʏ ⁚ ˹ [sʏɴᴀx](https://t.me/SynaxBots) ˼
───────────────────────**
'''
    HELP_ABOUT = '''
**───────────────────────
...
● ᴧɪ ɪηᴛєɢʀᴧᴛɪση
───────────────────────
❖ υᴘᴅᴧᴛєs ᴄʜᴧηηєʟ ➥ [sʏɴᴀx υᴘᴅᴧᴛє](https://t.me/SynaxBots)
❖ sυᴘᴘσʀᴛ ᴄʜᴧᴛ ➥ [sʏɴᴀx sυᴘᴘσʀᴛ](https://t.me/Synaxchatgroup)
❖ ʀєᴧʟ σᴡηєʀ ➥ [sʏɴᴀx sᴧηᴧᴛᴧηɪ](https://t.me/SynaxBots)
───────────────────────
